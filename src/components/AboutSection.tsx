    ...
    <section ref={sectionRef} id="about" className="py-16 sm:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          {/* LEFT — Spline Robot - Hidden on mobile using max-sm:hidden */}
          <div className="max-sm:hidden about-avatar opacity-0 relative h-[300px] sm:h-[400px] md:h-[520px]">
            <div
          ...
          <div className="about-content opacity-0 text-center md:text-left">
            <h2 className="text-xs font-bold tracking-[4px] uppercase mb-4 sm:mb-6" style={{ color: "#00FFFF" }}>
              ABOUT ME
            </h2>
            <p className="text-sm sm:text-base leading-relaxed mb-4 sm:mb-6" style={{ color: "#888" }}>
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-6 mb-6 sm:mb-8">
              {[
                ...
                <div key={i} className="text-center p-3 sm:p-4 rounded-xl" style={{ background: "#111", border: "1px solid #1a1a1a" }}>
                  <div className="text-xl sm:text-2xl font-black" style={{ color: "#00FFFF" }}>{s.num}</div>
                  <div className="text-[10px] sm:text-xs mt-1" style={{ color: "#555" }}>{s.label}</div>
                </div>
              ))}
            </div>
